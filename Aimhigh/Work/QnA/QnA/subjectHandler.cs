...
namespace QnA
{
    class subjectHandler : databaseHandler
    {
        ...
        public string testNameChecker(string x)
        {
            base.openConnection();
            string identify;
            OdbcDataAdapter sda = new OdbcDataAdapter("Select Count(*) From Test WHERE TEST='"+x+"'", con);
        ...
        public List<string> listSubject()
        {
            ...
            OdbcDataAdapter sda = new OdbcDataAdapter("SELECT TOPIC FROM TopicT", con);
            ds = new DataSet();
            sda.Fill(ds, "TopicT");
        ...
        public List<string> listQuestions(string topic)
        {
            ...
            base.openConnection();
            OdbcDataAdapter sdaQuestion = new OdbcDataAdapter("SELECT QUESTION FROM Question,TopicT WHERE TopicT.Id=Question.topicT AND TopicT.Id=" + pKey + "", con);
        ...
        public void insertSubject(string j, string x)
        {
            ...
            if (x != null)
            {
                ...
                cmd = new OdbcCommand("INSERT INTO TopicT (TOPIC, DESCRIPTION) VALUES ('" + j + "', '" + x + "')", con);
            ...
            {
                cmd = new OdbcCommand("INSERT INTO TopicT (TOPIC) VALUES ('" + j + "')", con);
                sda = new OdbcDataAdapter(cmd);
                cmd.ExecuteNonQuery();
                con.Close();
            }
        ...
        public void insertQuestion(string parent, string qname, string descrption)
        {
            ...
            if (descrption != null)
            {
                cmd = new OdbcCommand("INSERT INTO Question (QUESTION, DESCRIPTION, topicT) VALUES ('" + qname + "', '" + descrption + "', " + pKey + ")", con);
                sda = new OdbcDataAdapter(cmd);
                cmd.ExecuteNonQuery();
            ...
            {
                cmd = new OdbcCommand("INSERT INTO Question (QUESTION, topicT) VALUES ('" + qname + "', " + pKey + ")", con);
                sda = new OdbcDataAdapter(cmd);
                cmd.ExecuteNonQuery();
        ...
        private void createSQTable()
        {
            try
            {
                ...
                cmd = new OdbcCommand(create, con);
                sda = new OdbcDataAdapter(cmd);
                cmd.ExecuteNonQuery();
                con.Close();
                counter++;
        ...
        public void deleteChapter(string parent, string topicT)
        {
            ...
            try
            {
                cmd = new OdbcCommand(chapter, con);
                sda = new OdbcDataAdapter(cmd);
                cmd.ExecuteNonQuery();
            }
            catch
        ...
        {
            base.openConnection();
            cmd = new OdbcCommand("INSERT INTO Test (TEST) VALUES ('" + testName + "')", con);
            sda = new OdbcDataAdapter(cmd);
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        public void insertTestQuestions(string testName, string question, string topic)
        {
            ...
            base.openConnection();
            cmd = new OdbcCommand("INSERT INTO TestListQuestion (QUESTION, test, subject) VALUES ('"+question+"', "+pKey+", '"+topic+"')", con);
            sda = new OdbcDataAdapter(cmd);
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        public void insertTestContents(string parent, string topicT, string testParent)
        {
            ...
            try
            {
                cmd = new OdbcCommand("INSERT INTO TestContents (Boxes, contents, TLQ) SELECT Boxes, contents, " + pKey + " FROM SQ WHERE Question=" + qPK + "", con);
                sda = new OdbcDataAdapter(cmd);
                cmd.ExecuteNonQuery();
            }
            catch
        ...
        {
            OdbcDataAdapter sda = new OdbcDataAdapter("SELECT TEST FROM Test", con);
            ds = new DataSet();
            sda.Fill(ds, "Test");
        ...
        public List<Test.TestData> listTestQuestion(string parent)
        {
            ...
            base.openConnection();
            cmd = new OdbcCommand("SELECT QUESTION, subject FROM TestListQuestion,Test WHERE Test.Id=TestListQuestion.test AND Test.Id=" + pKey + "", con);
        ...
        public string getVariable(string parent, string topicT)
        {
            ...
            {
                string variable = "";
                cmd = new OdbcCommand("SELECT contents FROM SQ WHERE Question=" + pKey + " AND Boxes='variable'", con);
                dr = cmd.ExecuteReader();
                while (dr.Read())
                {
        ...
        public string getTestVariable(string parent, string testParent)
        {
            ...
            {
                string variable = "";
                cmd = new OdbcCommand("SELECT contents FROM TestContents WHERE TLQ=" + pKey + " AND Boxes='variable'", con);
                dr = cmd.ExecuteReader();
                while (dr.Read())
                {
                    variable = dr[0].ToString();
